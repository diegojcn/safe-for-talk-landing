        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <span className="text-slate-300 text-sm font-medium">{t('hero-social-proof')}</span>
            ...
            >
              ...
              <a
                href="https://apps.apple.com/us/app/safe-4-talk/id6778502736?l=pt-BR"
                target="_blank" rel="noopener noreferrer"
                onClick={() => trackEvent(Events.ClickAppStore, { source: 'hero' })}
                className="inline-flex items-center gap-3 bg-white text-gray-900 px-5 py-3 rounded-xl hover:bg-slate-100 transition-all font-semibold shadow-lg shadow-white/10"
              >
                ...
                <div className="text-left">
                  <span className="text-[10px] leading-none block text-gray-500 uppercase tracking-wide">{t('site-header-apple-one')}</span>
                  <span className="text-sm font-bold leading-none">{t('site-header-apple-two')}</span>
                </div>
              </a>
